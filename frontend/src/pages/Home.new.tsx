              ...
              >
                <Box position="relative" w="full" h="400px">
                  {chainProperties.map((chain, index) => {
                    const angle = (index * 360) / chainProperties.length;
                    const radius = 150;
                    ...
                    return (
                      ...
                      >
                        <VStack
                          ...
                          w="120px"
                        >
                          <Circle size="40px" bg={`${chain.color}.500`} color="white">
                            <Icon as={chain.icon} w={5} h={5} />
                          </Circle>
                          <Text fontWeight="bold" color={`${chain.color}.700`}>
                            {chain.title}
                          </Text>
                        </VStack>
                      </MotionBox>
                  ...
                  <Circle
                    ...
                    shadow="lg"
                  >
                    <Text fontWeight="bold">供应链思维</Text>
                  </Circle>
                </Box>
              </MotionFlex>
            </GridItem>
